...
public final class NotesDatabase_Impl extends NotesDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsNotesTable = new HashMap<String, TableInfo.Column>(13);
        ...
        _columnsNotesTable.put("color", new TableInfo.Column("color", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final HashMap<String, TableInfo.Column> _columnsNoteTags = new HashMap<String, TableInfo.Column>(4);
        _columnsNoteTags.put("tagId", new TableInfo.Column("tagId", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNoteTags.put("noteId", new TableInfo.Column("noteId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNoteTags.put("name", new TableInfo.Column("name", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNoteTags.put("color", new TableInfo.Column("color", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysNoteTags = new HashSet<TableInfo.ForeignKey>(1);
        _foreignKeysNoteTags.add(new TableInfo.ForeignKey("notes_table", "CASCADE", "NO ACTION", Arrays.asList("noteId"), Arrays.asList("noteId")));
        final HashSet<TableInfo.Index> _indicesNoteTags = new HashSet<TableInfo.Index>(1);
        _indicesNoteTags.add(new TableInfo.Index("index_noteTags_noteId", false, Arrays.asList("noteId"), Arrays.asList("ASC")));
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "notes_table","noteTags","checklist");
  }
